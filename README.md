...
a single <code>make</code> invocation without hand-editing build configuration
for standard project layouts.</p>
...
<pre><code>  cmb extra-files . README.md
  cmd extra-files share share/config.json 
</code></pre>
</li>
</ul>
